...
def menu_controles():
    ...
    font = pygame.font.Font('nuevo_juego/fonts/game.otf',20)
    font2 = pygame.font.Font('nuevo_juego/fonts/game.otf', 50)
    seleccion = None
...
def main():
    ...
    while run:
        ...
        for enemigo in colicion1:
            ...
            explosion_sonido.set_volume(0.077)
...
def mostrar_game_over(puntuacion):
    ...
    font = pygame.font.Font('nuevo_juego/fonts/game.otf', 30)
